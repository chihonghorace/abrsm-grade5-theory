...
export default function Mock({ api }: Props) {
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="clay-soft p-5">
          <h2 className="mb-3 text-lg font-extrabold text-ink">By topic</h2>
  ...
  return (
    <div className="space-y-4">
      <div className="sticky top-0 z-10 -mx-4 flex items-center justify-between bg-app/90 px-4 py-2 backdrop-blur">
